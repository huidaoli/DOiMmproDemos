package com.can2do.doimmpro.im.global;
...
public class IMConstant {
	...
	// 新消息
	public static final String ACTION_NEW_MESSAGE = ACTION_SUFFIX
			+ ".NEW_MESSAGE";
	// 回话消息
	public static final String ACTION_CHAT_MESSAGE = ACTION_SUFFIX
			+ ".CHAT_MESSAGE";
	// 系统消息
	public static final String ACTION_SYS_MESSAGE = ACTION_SUFFIX
			+ ".SYS_MESSAGE";
	 ...
	 * 花名册有删除的ACTION和KEY
	 */
	public static final String ACTION_ROSTER_DELETED = ACTION_SUFFIX
			+ ".ROSTER_DELETED";
	 ...
	 * 花名册有更新的ACTION和KEY
	 */
	public static final String ACTION_ROSTER_UPDATED = ACTION_SUFFIX
			+ ".ROSTER_UPDATED";
	 ...
	 * 花名册有增加的ACTION和KEY
	 */
	public static final String ACTION_ROSTER_ADDED = ACTION_SUFFIX
			+ ".ROSTER_ADDED";
	 ...
	 */
	public static final String ACTION_ROSTER_PRESENCE_CHANGED = ACTION_SUFFIX
			+ ".ROSTE_RPRESENCE_CHANGED";
	public static final String ROSTER_PRESENCE_CHANGED_KEY = "roster.presence.changed.key";

	/**
	 * 收到好友邀请请求
	 */
	public static final String ACTION_ROSTER_SUBSCRIPTION = ACTION_SUFFIX
			+ ".ROSTER_SUBSCRIBE";
	 ...
	 * 
	 */
	public static final String ACTION_RECONNECT_STATE = ACTION_SUFFIX
