			...
			public void onClick(View v) {
				...
				mAbHttpUtil.get(urlString, new AbStringHttpResponseListener() {
					...
					public void onSuccess(int statusCode, String content) {
						...
						AbDialogUtil.showAlertDialog(HttpActivity.this, "返回结果",
								content.trim(), new AbDialogOnClickListener() {
					...
					public void onFailure(int statusCode, String content,
						...
						Log.d(TAG, "onFailure");
						AbToastUtil.showToast(HttpActivity.this,
								error.getMessage());
					}
					...
					public void onStart() {
						Log.d(TAG, "onStart");
						// 显示进度框
						AbDialogUtil.showProgressDialog(HttpActivity.this, 0,
								"正在查询...");
					}
			...
			public void onClick(View v) {
				...
				mAbHttpUtil.post(url, params,
						new AbStringHttpResponseListener() {
							...
							public void onSuccess(int statusCode, String content) {
								Log.d(TAG, "onSuccess");
								AbDialogUtil.showAlertDialog(HttpActivity.this,
										"返回结果", content,
			...
			public void onClick(View v) {
				...
				mAbHttpUtil.get(url, new AbBinaryHttpResponseListener() {
					...
					public void onSuccess(int statusCode, byte[] content) {
						...
						AbDialogUtil.showAlertDialog("返回结果", view,
								new AbDialogOnClickListener() {
			...
			public void onClick(View v) {
				...
				mAbHttpUtil.get(url, new AbFileHttpResponseListener(url) {
					...
					public void onStart() {
						Log.d(TAG, "onStart");
						// 打开进度框
						View v = LayoutInflater.from(HttpActivity.this)
								.inflate(R.layout.progress_bar_horizontal,
										null, false);
				...
				mAbHttpUtil.post(url, params,
						new AbStringHttpResponseListener() {
							...
							public void onStart() {
								...
								mAlertDialog = AbDialogUtil.showAlertDialog(
										"正在上传", v);
							}
