...
import com.can2do.doimmpro.demo.adapter.ImageListAdapter;
import com.can2do.doimmpro.global.Constant;
import com.can2do.doimmpro.global.MyApplication;

public class ListNestViewPagerActivity extends AbActivity implements
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mSlidingPlayView
				.setOnItemClickListener(new AbSlidingPlayView.AbOnItemClickListener() {
					...
					public void onClick(int position) {
						AbToastUtil.showToast(ListNestViewPagerActivity.this,
								"点击" + position);
					}
				});
		...
		AbDialogUtil.showProgressDialog(ListNestViewPagerActivity.this,
			...
			public void get() {
				try {
					...
					AbToastUtil.showToastInThread(
							ListNestViewPagerActivity.this, e.getMessage());
				}
			};
		});
