...
import com.can2do.doimmpro.demo.adapter.ListPopAdapter;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		btn3.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				Button about = (Button) rightViewMore
			...
			public void onClick(View v) {
				...
				mAbTitleBar.setLogoOnClickListener(new OnClickListener() {
					...
					public void onClick(View v) {
						...
						mAbTitleBar.clearRightView();
						mAbTitleBar.setLogo(R.drawable.button_selector_back);
						mAbTitleBar.setTitleBarGravity(Gravity.LEFT,
								Gravity.RIGHT);
						mAbTitleBar.setTitleTextMargin(20, 0, 0, 0);
						mAbTitleBar.getLogoView2().setVisibility(View.GONE);
						mAbTitleBar
								.setLogoOnClickListener(new OnClickListener() {
		...
		btn6.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				// 关于界面
				Intent intent = new Intent(TitleBarActivity.this,
						AboutActivity.class);
		...
		btn7.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				ListPopAdapter mListPopAdapter = new ListPopAdapter(
						TitleBarActivity.this, list, R.layout.item_list_pop);
		...
		btn9.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				ListPopAdapter mListPopAdapter = new ListPopAdapter(
						TitleBarActivity.this, list, R.layout.item2_list_pop);
				popListView.setAdapter(mListPopAdapter);
