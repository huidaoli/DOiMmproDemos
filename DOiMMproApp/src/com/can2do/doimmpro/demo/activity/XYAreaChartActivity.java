...
/**
 * © 2012 amsoft.cn。 名称：XYAreaChartActivity 描述：区域图
 * 
 * @version
 */
public class XYAreaChartActivity extends AbActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		colors.add(new int[] { Color.BLUE, Color.GREEN, Color.RED, Color.BLACK,
				Color.GRAY, Color.YELLOW, Color.BLUE });
		...
		View chart = ChartFactory.getAreaChartView(this,
				mXYMultipleSeriesDataset, renderer, 0.5f);
