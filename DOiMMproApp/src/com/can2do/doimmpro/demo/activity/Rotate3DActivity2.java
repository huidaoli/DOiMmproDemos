...
/**
 * 
 * © 2012 amsoft.cn 名称：Rotate3DActivity2.java 描述：3d旋转View
 * 
 * @version v1.0
 */
public class Rotate3DActivity2 extends Activity {
	...
	public void initFirst() {
		leftAnimation = new AbRotate3dAnimation2(0, -90, 0.0f, 0.0f, mCenterX,
				mCenterY);
		rightAnimation = new AbRotate3dAnimation2(90, 0, 0.0f, 0.0f, mCenterX,
				mCenterY);
	...
	public void initSecond() {
		leftAnimation = new AbRotate3dAnimation2(-90, 0, 0.0f, 0.0f, mCenterX,
				mCenterY);
		rightAnimation = new AbRotate3dAnimation2(0, 90, 0.0f, 0.0f, mCenterX,
				mCenterY);
		leftAnimation.setFillAfter(true);
		leftAnimation.setDuration(1000);
		rightAnimation.setFillAfter(true);
