...
public class NestScrollActivity extends AbActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		Button slidingMenuPager = (Button) this
				.findViewById(R.id.slidingMenuPager);
		...
		listPager.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				Intent intent = new Intent(NestScrollActivity.this,
						ListNestViewPagerActivity.class);
		...
		slidingMenuPager.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				Intent intent = new Intent(NestScrollActivity.this,
						SlidingMenuNestViewPagerActivity.class);
				startActivity(intent);
			}
		});
		...
		scrollPager.setOnClickListener(new View.OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				AbDialogUtil.showAlertDialog(NestScrollActivity.this, "提示",
						"把你的ScrollView换成AbOuterScrollView就可以了",
