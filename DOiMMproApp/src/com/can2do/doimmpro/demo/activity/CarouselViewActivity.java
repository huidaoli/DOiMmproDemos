...
/**
 * 
 * © 2012 amsoft.cn 名称：CarouselViewActivity.java 描述：View适配的旋转木马
 * 
 * @version v1.0
 */
public class CarouselViewActivity extends AbActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		int[] drawables = new int[] { R.drawable.icon1, R.drawable.icon2,
		...
		for (int i = 0; i < 6; i++) {
			View convertView = mInflater.inflate(R.layout.carousel_item_view,
					null, false);
		...
		CarouselViewAdapter adapter = new CarouselViewAdapter(this, mViews,
				true);
		...
		carousel.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(CarouselAdapter<?> parent, View view,
				...
				AbToastUtil.showToast(CarouselViewActivity.this,
