...
public class ImageDownActivity extends AbActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		String imageUrl = Constant.BASEURL
				+ "content/templates/amsoft/images/rand/0.jpg";
		String imageUrl2 = Constant.BASEURL
				+ "content/templates/amsoft/images/rand/1.jpg";
		String imageUrl3 = Constant.BASEURL
				+ "content/templates/amsoft/images/rand/2.jpg";
