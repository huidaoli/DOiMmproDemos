...
public class AnalogClockActivity extends AbActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		Drawable hourHand = this.getResources().getDrawable(
				R.drawable.clock_hour);
		Drawable minuteHand = this.getResources().getDrawable(
				R.drawable.clock_minute);
		Drawable secondHand = this.getResources().getDrawable(
				R.drawable.clock_second);
		AbAnalogClock view = new AbAnalogClock(this, dial, hourHand,
				minuteHand, secondHand);

		LinearLayout contentLayout = (LinearLayout) this
