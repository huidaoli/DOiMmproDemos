...
/**
 * © 2012 amsoft.cn。 名称：XYLineChartActivity 描述：线图
 * 
 * @version
 */
public class TimeChartActivity extends AbActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		values.add(new double[] { 15, 16, 17, 18, 19, 20, 19, 18, 17, 16, 15,
				15, 16, 17, 18, 19, 20, 19, 18, 17, 16, 15, 16, 17 });
		values.add(new double[] { 0, 1, 2, 3, 4, 5, 4, 3, 2, 1, 0, 0, 1, 2, 3,
				4, 5, 4, 3, 2, 1, 0, 1, 2 });
		...
		int[] colorsLimit = new int[] { Color.rgb(221, 241, 248),
				Color.rgb(221, 241, 248), Color.rgb(233, 242, 222),
				Color.rgb(233, 242, 222) };
		...
		// 线图
		View chart = ChartFactory.getTimeChartView(this,
				mXYMultipleSeriesDataset, renderer, "MM-dd HH:mm");
