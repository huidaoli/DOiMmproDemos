				...
				mAbSoapUtil.call(urlString, nameSpace, methodName, params,
						new AbSoapListener() {
							...
							public void onSuccess(int statusCode,
								...
								AbDialogUtil.showAlertDialog(SoapActivity.this,
										"返回结果", object.toString(),
							...
							public void onFailure(int statusCode,
								...
								AbToastUtil.showToast(SoapActivity.this,
										error.getMessage());
							}
