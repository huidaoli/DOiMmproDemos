	...
	public void onCreate(Bundle savedInstanceState) {
		...
		threadBtn.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				// 显示进度框
				AbDialogUtil.showProgressDialog(ThreadControlActivity.this,
				...
				item.setListener(new AbTaskListener() {
					...
					public void update() {
						...
						AbToastUtil.showToast(ThreadControlActivity.this,
								"执行完成");
					}
					...
					public void get() {
						try {
							AbToastUtil.showToastInThread(
									ThreadControlActivity.this, "开始执行");
							Thread.sleep(3000);
							// 下面写要执行的代码，如下载数据
						} catch (Exception e) {
						}
			...
			public void onClick(View arg0) {
				...
				item1.setListener(new AbTaskObjectListener() {
					...
					public String getObject() {
						String msg1 = "amsoft";
						AbToastUtil.showToastInThread(
								ThreadControlActivity.this, "开始执行1," + msg1);
						try {
							Thread.sleep(2000);
						} catch (Exception e) {
						}
				...
				item2.setListener(new AbTaskListener() {
					...
					public void get() {
						try {
							...
							Thread.sleep(2000);
							AbToastUtil.showToastInThread(
									ThreadControlActivity.this, "开始执行2");
							// 下面写要执行的代码，如下载数据
						} catch (Exception e) {
						}
					};
