...
import com.can2do.doimmpro.demo.adapter.CheckListViewAdapter;
...
public class SlidingButtonActivity extends AbActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		CheckListViewAdapter simpleAdapter = new CheckListViewAdapter(this,
				list, R.layout.item_list_button, new String[] { "itemsTitle",
						"itemsText", "itemsCheck" }, new int[] {
