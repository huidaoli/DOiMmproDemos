...
import com.can2do.doimmpro.demo.adapter.MyExpandableListAdapter;
...
public class DownListActivity extends AbActivity {
	...
	private void initDownFileList() {
		...
		mDownFile1
				.setDownUrl("http://down.apk.hiapk.com/down?aid=1832508&em=13");
		...
		for (DownFile mDownFile : mDownFileList) {
			// 本地数据
			DownFile mDownFileT = mDownFileDao.getDownFile(mDownFile
					.getDownUrl());
			if (mDownFileT != null) {
