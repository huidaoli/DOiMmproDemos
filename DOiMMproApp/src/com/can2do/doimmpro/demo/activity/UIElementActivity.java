...
/**
 * © 2012 amsoft.cn 名称：UIElementActivity.java 描述：常用控件汇总.
 * 
 * @version v1.0
 */
...
public class UIElementActivity extends AbActivity {
	...
	@AbIocView(id = R.id.button1, click = "btnClick")
	Button button1;
	...
	public void btnClick(View v) {
		...
		case R.id.button1:
			// 滑动按钮
			intent = new Intent(UIElementActivity.this,
					SlidingButtonActivity.class);
			startActivity(intent);
			break;
		case R.id.button2:
			// 图片轮播
			intent = new Intent(UIElementActivity.this,
					SlidingPlayViewActivity.class);
			startActivity(intent);
			break;
		case R.id.button3:
			// 日历选择器
