...
public class PopoverActivity extends AbActivity implements OnClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		popoverView
				.setPopoverViewListener(new AbPopoverView.PopoverViewListener() {
	...
	public void onClick(View v) {
		popoverView.setPopoverContentView(mInflater.inflate(
				R.layout.popover_showed_view, null));
		popoverView.showPopoverFromRectInViewGroup(rootView,
				AbPopoverView.getFrameForView(v),
				AbPopoverView.PopoverArrowDirectionAny, true);
	}
