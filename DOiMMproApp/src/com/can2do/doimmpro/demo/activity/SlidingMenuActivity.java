...
public class SlidingMenuActivity extends AbActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		btn3.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				Intent intent = new Intent(SlidingMenuActivity.this,
						SlidingMenuRightActivity.class);
				startActivity(intent);
			}
		});
		...
		btn4.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				Intent intent = new Intent(SlidingMenuActivity.this,
						SlidingMenuLeftRightActivity.class);
				startActivity(intent);
			}
		});
		...
		btn5.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				Intent intent = new Intent(SlidingMenuActivity.this,
						SlidingMenuTitleHoldActivity.class);
				startActivity(intent);
			}
		});
		...
		btn6.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				Intent intent = new Intent(SlidingMenuActivity.this,
						SlidingMenuScaleActivity.class);
				startActivity(intent);
			}
		});
		...
		btn7.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				Intent intent = new Intent(SlidingMenuActivity.this,
						SlidingMenuSlideActivity.class);
				startActivity(intent);
			}
		});
