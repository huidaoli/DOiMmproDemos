...
import com.can2do.doimmpro.demo.adapter.UserDBListAdapter;
import com.can2do.doimmpro.demo.dao.UserInsideDao;
import com.can2do.doimmpro.demo.model.LocalUser;
import com.can2do.doimmpro.global.MyApplication;

/**
 * 名称：DBObjectActivity 描述：数据库演示andbase的对象化存储
 * 
 * @version
 */
public class DBObjectActivity extends AbActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// 分页栏
		mListViewForPage = (LinearLayout) this
				.findViewById(R.id.mListViewForPage);
		// 上一页和下一页的按钮
		...
		// 增加的字段数据
		final EditText mEditText = (EditText) headerView
	...
	public void queryData() {
		...
		// 无sql存储的查询
		mAbSqliteStorage.findData(mAbStorageQuery, userDao,
				new AbDataSelectListener() {

					@Override
					public void onFailure(int errorCode, String errorMessage) {
						AbToastUtil.showToast(DBObjectActivity.this,
								errorMessage);
					}
					...
					public void onSuccess(List<?> paramList) {
						if (paramList != null && paramList.size() > 0) {
							...
							AbToastUtil.showToast(
									DBObjectActivity.this,
									"结果：_id:" + u.get_id() + ",name:"
											+ u.getName());
						}
					}
	...
	public void delData(int id) {
		...
		// 无sql存储的删除
		mAbSqliteStorage.deleteData(mAbStorageQuery, userDao,
