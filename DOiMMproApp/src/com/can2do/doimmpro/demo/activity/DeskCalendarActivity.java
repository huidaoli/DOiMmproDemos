...
public class DeskCalendarActivity extends AbActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		Drawable caleBg = this.getResources().getDrawable(
				R.drawable.desk_calendar);
		...
		AbCalendar view = new AbCalendar(this, caleBg, caleDot, posYear,
				dYearArray, posMonth, dMonthArray, posDate, dDateArray,
				posWeek, dWeekArray);
