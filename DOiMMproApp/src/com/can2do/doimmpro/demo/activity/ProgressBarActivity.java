...
/**
 * 名称：ProgressBarActivity 描述：2种漂亮的进度条
 * 
 * @version
 */
public class ProgressBarActivity extends AbActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		Button mHorizontalView = (Button) this
				.findViewById(R.id.mHorizontalView);

		mCircleView.setOnClickListener(new View.OnClickListener() {

			@Override
			public void onClick(View v) {
				Intent intent = new Intent(ProgressBarActivity.this,
						ProgressBarCircleActivity.class);
		...
		mHorizontalView.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				Intent intent = new Intent(ProgressBarActivity.this,
						ProgressBarHorizontalActivity.class);
				startActivity(intent);
			}
		});
