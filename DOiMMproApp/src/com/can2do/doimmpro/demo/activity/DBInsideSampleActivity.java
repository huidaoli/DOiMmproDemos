...
/**
 * 名称：DBInsideSampleActivity 描述：数据库演示内置数据库存储
 * 
 * @version
 */
public class DBInsideSampleActivity extends AbActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// (2)执行查询
		userList = userDao.queryList(null, null, null, null, null,
		...
		addBtn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (name != null && !"".equals(name.trim())) {
					...
					AbToastUtil
							.showToast(DBInsideSampleActivity.this, "请输入名称!");
				}
			}
		});
	...
	public void queryData() {
		...
		userDao.startReadableDatabase();
		// (2)执行查询
		List<LocalUser> userListNew = userDao
				.queryList(
						null,
						null,
						null,
