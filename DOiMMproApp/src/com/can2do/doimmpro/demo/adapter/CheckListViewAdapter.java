...
/**
 * © 2012 amsoft.cn 名称：MyListViewAdapter 描述：ListView自定义Adapter例子
 * 
 * @version
 */
public class CheckListViewAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			holder.itemsCheck = ((AbSlidingButton) convertView
					.findViewById(mTo[2]));
			// 设置标记
		...
		// 设置开关显示所用的图片
		holder.itemsCheck.setImageResource(R.drawable.btn_bottom,
