...
import com.can2do.doimmpro.demo.model.ImageInfo;
...
public class MultiColumnImageListAdapter extends AbMultiColumnListAdapter {
	...
	@Override
	public AbViewInfo getView(int position, AbViewInfo convertView,
			ViewGroup parent) {
		...
		if (convertView == null) {
			...
			View view = LayoutInflater.from(mContext).inflate(
					R.layout.multi_list_items, parent);
		...
		// 设置加载中的View
		mAbImageLoader.setLoadingView(convertView.getView().findViewById(
				R.id.progressBar));
