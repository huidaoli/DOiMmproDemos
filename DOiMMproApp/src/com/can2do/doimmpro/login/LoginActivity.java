		...
		checkBox.setOnCheckedChangeListener(new OnCheckedChangeListener() {
			...
			public void onCheckedChanged(CompoundButton buttonView,
				...
				AbSharedUtil.putBoolean(LoginActivity.this,
						Constant.USERPASSWORDREMEMBERCOOKIE, isChecked);
				application.userPasswordRemember = isChecked;
			}
		});

		String name = AbSharedUtil.getString(LoginActivity.this,
				Constant.USERNAMECOOKIE);
		String password = AbSharedUtil.getString(LoginActivity.this,
				Constant.USERPASSWORDCOOKIE);
		boolean userPwdRemember = AbSharedUtil.getBoolean(LoginActivity.this,
	...
	public class LoginOnClickListener implements View.OnClickListener {
		...
		public void onClick(View v) {
			if (v == loginBtn) {
				...
				AbDialogUtil.showProgressDialog(LoginActivity.this,
						R.drawable.ic_load, "登录到IM");
