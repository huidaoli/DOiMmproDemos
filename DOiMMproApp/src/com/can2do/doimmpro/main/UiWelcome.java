...
public class UiWelcome extends Activity {
	...
	private void setListener() {
		...
		mFadeOut.setAnimationListener(new AnimationListener() {
			...
			public void onAnimationStart(Animation animation) {
				...
				intent.setClass(UiWelcome.this, UiMain.class);
	...
	private void initAnim() {
		mFadeIn = AnimationUtils.loadAnimation(UiWelcome.this,
				R.anim.welcome_fade_in);
		mFadeIn.setDuration(1500);
		mFadeInScale = AnimationUtils.loadAnimation(UiWelcome.this,
				R.anim.welcome_fade_in_scale);
		mFadeInScale.setDuration(2000);
		mFadeOut = AnimationUtils.loadAnimation(UiWelcome.this,
