package com.can2do.doimmpro.web;
...
import com.can2do.doimmpro.demo.model.Article;
import com.can2do.doimmpro.demo.model.ArticleListResult;
...
public class NetworkWeb {
	...
	public void findLogList(AbRequestParams params,
		...
		final String result = AbFileUtil.readAssetsByName(mContext,
				"article_list.json", "UTF-8");
		// 一个url地址
		String urlString = "http://www.amsoft.cn/rss.php?";
			...
			public void onSuccess(int statusCode, String content) {
				try {
					...
					if (result.getResultCode() > 0) {
						// 成功
						ArticleListResult mArticleListResult = (ArticleListResult) AbJsonUtil
