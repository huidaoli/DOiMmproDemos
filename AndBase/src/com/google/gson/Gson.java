...
public final class Gson {
	...
	public Gson() {
		this(Excluder.DEFAULT, FieldNamingPolicy.IDENTITY, Collections
				...
				LongSerializationPolicy.DEFAULT, Collections
	...
	static {
		GsonInternalAccess.INSTANCE = new GsonInternalAccess() {
			@Override
			public <T> TypeAdapter<T> getNextAdapter(Gson gson,
				...
				throw new IllegalArgumentException("GSON cannot serialize "
						+ type);
			}
		};
	}
	...
	public String toString() {
		StringBuilder sb = new StringBuilder("{").append("serializeNulls:")
				.append(serializeNulls).append("factories:").append(factories)
