...
/**
 * The listener interface for receiving abIocEvent events. The class that is
 * interested in processing a abIocEvent event implements this interface, and
 ...
 * @see AbIocEventEvent
 */
public class AbIocEventListener implements OnClickListener,
	 ...
	 */
	private boolean invokeLongClickMethod(Object handler, String methodName,
			Object... params) {
		if (handler == null)
			return false;
		Method method = null;
	 ...
	 * @return the object
	 */
	private Object invokeItemClickMethod(Object handler, String methodName,
			Object... params) {
		if (handler == null)
			return null;
		Method method = null;
	 ...
	 * @return the object
	 */
	private Object invokeItemSelectMethod(Object handler, String methodName,
			Object... params) {
		if (handler == null)
			return null;
		Method method = null;
	 ...
	 * @return the object
	 */
	private Object invokeNoSelectMethod(Object handler, String methodName,
			Object... params) {
		if (handler == null)
			return null;
		Method method = null;
