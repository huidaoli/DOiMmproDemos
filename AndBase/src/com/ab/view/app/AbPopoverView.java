...
public class AbPopoverView extends RelativeLayout implements OnTouchListener {
	...
	/**
	 * Get the Rect frame for a view (relative to the Window of the
	 * application).
	 * 
	 * @param v
			...
			if (!isAnimating) {
				...
				animation.setAnimationListener(new AnimationListener() {
					...
					public void onAnimationEnd(Animation animation) {
						...
						if (popoverViewListener != null)
							popoverViewListener
									.popoverViewDidShow(AbPopoverView.this);
					}
				});
			...
			if (!isAnimating) {
				...
				animation.setAnimationListener(new AnimationListener() {
					...
					public void onAnimationEnd(Animation animation) {
						...
						popoverView.removeAllViews();
						removeAllViews();
						AbPopoverView.this.superview
								.removeView(AbPopoverView.this);
						// End animation
						isAnimating = false;
						// Tell delegate we did dismiss
						if (popoverViewListener != null)
							popoverViewListener
									.popoverViewDidDismiss(AbPopoverView.this);
					}
				});
	...
	public void setPopoverContentView(View popoverContentView) {
		...
		popoverView.removeAllViews();
		popoverView.addView(popoverContentView, LayoutParams.FILL_PARENT,
