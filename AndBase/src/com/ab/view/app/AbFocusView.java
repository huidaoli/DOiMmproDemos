...
public class AbFocusView extends LinearLayout implements OnFocusChangeListener {
	...
	public AbFocusView(Context context, AttributeSet attrs, int defStyle) {
		 ...
		 * R.styleable.AbFocusView, defStyle, 0); selectorDrawable =
		 * a.getDrawable(R.styleable.AbFocusView_borderDrawable); a.recycle();
		 * if (this.selectorDrawable != null) {
		 * this.setBackgroundDrawable(selectorDrawable); }
		 */
		/*
		 * <?xml version="1.0" encoding="utf-8"?> <resources> <!-- focus view
		 * --> <declare-styleable name="AbFocusView"> <attr
		 * name="borderDrawable" format="reference" /> </declare-styleable>
		 * 
		 * </resources>
		 */
	 ...
	 * 
	 * @param selectorResourse
	 *            the new selector resourse
	 */
	public void setSelectorResourse(int selectorResourse) {
		this.selectorResourse = selectorResourse;
		this.selectorDrawable = this.getResources().getDrawable(
				selectorResourse);
		if (this.selectorDrawable != null) {
			this.setBackgroundDrawable(selectorDrawable);
		}
