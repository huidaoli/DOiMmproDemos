...
public class ScatterChart extends XYChart {
	 ...
	 * @param renderer
	 *            the renderer
	 * @see com.ab.view.chart.XYChart#setDatasetRenderer(com.ab.view.chart.XYMultipleSeriesDataset,
	 ...
	 * @see com.ab.view.chart.XYChart#clickableAreasForPoints(float[], double[],
	 *      float, int, int)
	 * @author: amsoft.cn
	 * @date：2013-6-17 上午9:04:49
	 */
