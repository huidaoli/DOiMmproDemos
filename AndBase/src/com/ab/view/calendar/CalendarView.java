...
public class CalendarView extends LinearLayout {
	...
	public CalendarView(Context context, AttributeSet attrs) {
		...
		mLinearLayoutHeader.setLayoutParams(new LayoutParams(width,
				headerHeight));
	...
	public void initRow() {
		...
		for (int iRow = 0; iRow < 6; iRow++) {
			...
			mLinearLayoutRow
					.setLayoutParams(new LayoutParams(width, rowHeight));
			mLinearLayoutRow.setOrientation(LinearLayout.HORIZONTAL);
			for (int iDay = 0; iDay < 7; iDay++) {
				CalendarCell dayCell = new CalendarCell(context, (iRow * 7)
						+ iDay, cellWidth, rowHeight);
	...
	private void updateCalendar() {
		...
		for (int i = 0; i < mCalendarCells.size(); i++) {
			...
			dayCell.setThisCellDate(iYear, iMonth, iDay, bToday, bSelected,
					bHoliday, currentMonth, hasRecord);
	...
	private AbOnItemClickListener mOnDayCellClick = new AbOnItemClickListener() {
		...
		public void onClick(int position) {
			...
			if (mCalendarCell.isActiveMonth()) {
				calSelected.setTimeInMillis(mCalendarCell.getThisCellDate()
						.getTimeInMillis());
				for (int i = 0; i < mCalendarCells.size(); i++) {
