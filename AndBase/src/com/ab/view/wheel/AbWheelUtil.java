...
public class AbWheelUtil {
	 ...
	 *            轮子是否初始化默认时间为当前时间
	 */
	public static void initWheelDatePicker(final AbActivity activity,
		...
		okBtn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				mText.setText(AbStrUtil.dateTimeFormat(year + "-" + month + "-"
						+ day));
			}
	 ...
	 *            the init start
	 */
	public static void initWheelTimePicker2(final AbActivity activity,
