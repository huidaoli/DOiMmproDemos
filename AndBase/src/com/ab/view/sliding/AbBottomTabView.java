...
public class AbBottomTabView extends LinearLayout {
	...
	/** 图片尺寸. */
	private int mDrawablesBoundsLeft, mDrawablesBoundsTop,
			mDrawablesBoundsRight, mDrawablesBoundsBottom;
	...
	public AbBottomTabView(Context context, AttributeSet attrs) {
		...
		this.addView(mTabLayout, new LinearLayout.LayoutParams(
	...
	private void addTab(String text, int index, Drawable top) {
		...
		if (top != null) {
			...
			tabView.setTabCompoundDrawablesBounds(mDrawablesBoundsLeft,
					mDrawablesBoundsTop, mDrawablesBoundsRight,
					mDrawablesBoundsBottom);
		}
