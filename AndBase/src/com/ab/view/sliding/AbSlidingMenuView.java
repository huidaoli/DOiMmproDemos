...
/**
 * © 2012 amsoft.cn 名称：AbSlidingMenuView.java 描述：左右简单的侧边栏实现
...
public class AbSlidingMenuView extends ViewGroup {
	...
	public boolean dispatchTouchEvent(MotionEvent ev) {
		...
		case MotionEvent.ACTION_DOWN:
			AbLogUtil.d(AbSlidingMenuView.class,
			...
			if (mTouchState == TOUCH_STATE_RESTART) {
				...
				AbLogUtil.d(AbSlidingMenuView.class,
						"--dispatchTouchEvent ACTION_DOWN return false--");
				return false;
			}
			break;
		case MotionEvent.ACTION_MOVE:
			...
			if (mScrollState == SCROLL_STATE_ALLOW
				...
				AbLogUtil.d(AbSlidingMenuView.class,
						"--dispatchTouchEvent ACTION_MOVE return true--");
				return true;
			}
			break;
	...
	public boolean onInterceptTouchEvent(MotionEvent ev) {
		...
		case MotionEvent.ACTION_DOWN:
			...
			if (mTouchState == TOUCH_STATE_SCROLLING) {
				AbLogUtil.d(AbSlidingMenuView.class,
						"--onInterceptTouchEvent ACTION_DOWN return false--");
				return false;
			}
			break;
		...
		case MotionEvent.ACTION_MOVE:
			...
			if (mScrollState == SCROLL_STATE_ALLOW
				...
				AbLogUtil.d(AbSlidingMenuView.class,
						"--onInterceptTouchEvent ACTION_MOVE return true--");
				return true;
			}
			break;
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		case MotionEvent.ACTION_DOWN:
			AbLogUtil
					.d(AbSlidingMenuView.class, "--onTouchEvent ACTION_DOWN--");
			mTouchState = mScroller.isFinished() ? TOUCH_STATE_RESTART
					: TOUCH_STATE_SCROLLING;
			if (mTouchState == TOUCH_STATE_SCROLLING) {
				AbLogUtil.d(AbSlidingMenuView.class,
						"--onTouchEvent ACTION_DOWN return false--");
				return false;
			}
			break;
		...
		case MotionEvent.ACTION_MOVE:
			AbLogUtil
					.d(AbSlidingMenuView.class, "--onTouchEvent ACTION_MOVE--");
			mVelocityTracker.computeCurrentVelocity(1000,
					ViewConfiguration.getMaximumFlingVelocity());
