...
public class AbStorageQuery {
	 ...
	 * @return the ab storage query
	 */
	public AbStorageQuery greaterThanEqualTo(String paramString,
			Object paramObject) {
		if (!AbStrUtil.isEmpty(whereClause)) {
			whereClause += " and ";
		}
	 ...
	 * @param paramString
	 *            the param string
	 * @param paramSortOrder
	 *            the param sort order
	 * @return the ab storage query
	 */
	...
	public static void main(String[] args) {
		...
		AbStorageQuery mAbStorageQuery5 = mAbStorageQuery3
				.and(mAbStorageQuery4);
		...
		AbStorageQuery mAbStorageQuery8 = mAbStorageQuery6
				.and(mAbStorageQuery7);
