...
public class AbImageLoader {
	...
	/**
	 * The listener interface for receiving onImage events. The class that is
	 * interested in processing a onImage event implements this interface, and
	 * the object created with that class is registered with a component using
	 * the component's <code>addOnImageListener<code> method. When
